...
<nav class="navbar"> 
     ...
     <ul >
        <li>
            ...
            <li><a href="trimer.php">NEW IN</a></li>
            <li><a href="#arrival">WOMEN</a></li>
            <li><a href="#parlor">MEN</a></li>
            <li><a href="#garment">KIDS</a></li>
            <li><a href="#use">ACCESSORIES</a></li>
            <li><a href="#deal">HOME</a></li>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=22"><h3>PERFUME</h3></a>
...
<!-- Trimer End  -->
    ...
    <div class="box">
        ...
        <div class="info">
          <a href="trimer.php?p_cat=23">  <h3>MYSTIC ROSE</h3></a>
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=25"><h3>GLAM</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=26"><h3>DUSK</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=27"><h3>OOMPH</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=28"><h3>XOXO</h3></a>
...
<h1 class="heading"> <span>BEAUTY</span> </h1>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=45"><h3>CHARMr</h3></a>
...
<!-- Trimer End  -->
    ...
    <div class="box">
        ...
        <div class="info">
          <a href="trimer.php?p_cat=46">  <h3>CGRAVITY</h3></a>
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=47"> <h3>VICTOR</h3></a>
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=48"><h3>INFINITY</h3></a>
...
<h1 class="heading"> <span>HOME</span> </h1>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=49"><h3>QUILT COVER</h3></a>
...
<!-- Trimer End  -->
    ...
    <div class="box">
        ...
        <div class="info">
          <a href="trimer.php?p_cat=50">  <h3>BED SHEETS</h3></a>
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=51"> <h3>PILLOW COVER</h3></a>
    ...
    <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=52"><h3>PASTEL BED SHEET</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=53"><h3>CUSION COVER</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=54"><h3>BED SPREAD</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=55"><h3>PASTEL NECTOR</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=56"><h3>ONYX SHADOW</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=57"><h3>MINERAL-BUTTERFLY</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=58"><h3>BED SHEET</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=59"><h3>FITTED SHEETS</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=60"><h3>PEARLED COVER</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=61"><h3>WOMWN</h3></a>
     ...
     <div class="box">
        ...
        <div class="info">
            <a href="trimer.php?p_cat=63"><h3>FITTED SHEETS
